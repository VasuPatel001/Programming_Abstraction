...
private:
    ...
    /* Member function created by student
    */
    HashFunction<std::string> ourHashFn; //stores hashFn provided to us
    int allocatedSize;
    int numElems;
    void moveBackward(int currentIndex); // helper function for remove() of Robin Hood hash table
